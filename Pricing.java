...
Create a class Pricing that contains a method maxSales that takes a price containing the highest price that each potential customer is willing to pay, and returns the maximum sales revenue we can generate by differentiating our customers into four or fewer groups.
Definition
Class:
Pricing
Method:
